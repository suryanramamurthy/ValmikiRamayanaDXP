  ...
  "node_modules/@contentstack/utils/dist/index.es.js"(exports) {
    ...
    function findEmbeddedEntry(uid, contentTypeUid, embeddeditems) {
      ...
      return embeddeditems.filter(function(entry) {
        if (!entry)
          return false;
        return entry.uid && entry.uid === uid && entry._content_type_uid === contentTypeUid || entry.system && entry.system.uid === uid && entry.system.content_type_uid === contentTypeUid;
      });
    }
    function findEmbeddedAsset(uid, embeddedAssets) {
      ...
      return embeddedAssets.filter(function(asset) {
        if (!asset)
          return false;
        return asset.uid && asset.uid === uid || asset.system && asset.system.uid === uid;
      });
    }
    ...
    function getAttr(node, key) {
      var _a2;
      return (_a2 = node.attrs) === null || _a2 === void 0 ? void 0 : _a2[key];
    }
    function getAttrString(node, key) {
      var _a2;
      var value = (_a2 = node.attrs) === null || _a2 === void 0 ? void 0 : _a2[key];
    ...
    var defaultNodeOption = (_a = {}, _a[NodeType$1.DOCUMENT] = function() {
      return "";
      ...
      if (colWidths && Array.isArray(colWidths)) {
        var totalWidth_1 = colWidths.reduce(function(sum, width) {
          return sum + width;
        }, 0);
      ...
      if (type === "asset") {
        ...
        return "<figure".concat(styleAttrFig, ">") + (link ? '<a href="'.concat(link, '" target="').concat(target || "", '">') : "") + imageTag + (link ? "</a>" : "") + (caption ? "<figcaption>".concat(caption, "</figcaption>") : "") + "</figure>";
      }
      return "";
            ...
            if (Array.isArray(value)) {
              value.forEach(function(obj, index) {
                ...
                if (typeof obj !== "undefined" && obj !== null && obj._content_type_uid !== void 0 && obj.uid !== void 0) {
                  var newAppliedVariants = obj._applied_variants || ((_a3 = obj === null || obj === void 0 ? void 0 : obj.system) === null || _a3 === void 0 ? void 0 : _a3.applied_variants) || null;
    ...
    function getParentVariantisedPath(appliedVariants) {
      ...
      try {
        ...
        if (childPathFragments_1.length === 0 || variantisedFieldPaths.length === 0)
          return "";
        var parentVariantisedPath = (_a2 = variantisedFieldPaths.find(function(path) {
          var parentFragments = path.split(".");
          if (parentFragments.length > childPathFragments_1.length)
            return false;
          return parentFragments.every(function(fragment, index) {
            return childPathFragments_1[index] === fragment;
          });
        })) !== null && _a2 !== void 0 ? _a2 : "";
    ...
    function getContentstackEndpoint2(region, service, omitHttps) {
      if (region === void 0) {
        region = "us";
      }
      if (service === void 0) {
    ...
    function findRegionByIDOrAlias(regions2, regionInput) {
      var region = regions2.find(function(r) {
        return r.id === regionInput;
      });
      if (region) {
        return region;
      }
      region = regions2.find(function(r) {
        return r.alias.some(function(alias) {
          return alias.toLowerCase() === regionInput.toLowerCase();
        });
      });
      return region || null;
    }
    ...
    exports.getContentstackEndpoint = getContentstackEndpoint2;
...
// node_modules/@contentstack/delivery-sdk/dist/modern/lib/contentstack.js
...
// node_modules/@contentstack/core/dist/esm/src/lib/contentstack-core.js
var import_lodash = __toESM(require_lodash(), 1);

// node_modules/@contentstack/core/dist/esm/src/lib/param-serializer.js
...
function renderKey(path, key, dots) {
  if (!path) return key;
  return path.concat(key).map(function each3(token, i) {
  ...
  function defaultVisitor(value, key, path) {
    ...
    if (value && !path && typeof value === "object") {
      if (utils_default.endsWith(key, "{}")) {
        ...
        arr.forEach(function each3(el, index) {
...
// node_modules/@contentstack/core/dist/esm/src/lib/error-messages.js
var ERROR_MESSAGES = {
  // Console Logging Messages
  CONSOLE: {
    ERROR_WITH_TITLE: (title) => `Error: ${title}. Review the error details and try again.`,
    LEVEL_WITH_DATA: (level, data) => `${level}: ${data}. Review the details and try again.`
  },
  // API Error Messages
  API: {
    ...
    REQUEST_FAILED: (status) => status ? `Request failed with status ${status}. Please review your request and try again.` : "Request failed. Please review your request and try again."
  },
  ...
  RETRY: {
    TIMEOUT_EXCEEDED: (timeout) => `Request timeout of ${timeout}ms exceeded. Please try again or increase the timeout value in your configuration.`
  },
  // Error Codes
  ERROR_CODES: {
...
function httpClient(options) {
  ...
  const config = Object.assign(Object.assign({}, defaultConfig2), import_lodash.default.cloneDeep(options));
  ...
  const version2 = config.version || "v3";
  const baseURL = config.endpoint || `${protocol}://${hostname}:${port}${config.basePath}/${version2}`;
  const instance = axios_default.create(Object.assign(Object.assign({
    // Axios
    baseURL,
    adapter: getAdapter2(axios_default.defaults.adapter)
  }, config), { paramsSerializer: {
    serialize
  } }));
...
// node_modules/@contentstack/core/dist/esm/src/lib/api-error.js
var APIError = class _APIError extends Error {
  ...
  static fromAxiosError(err) {
    ...
    if ((_a = err.response) === null || _a === void 0 ? void 0 : _a.data) {
      return _APIError.fromResponseData(err.response.data, err.response.status);
    } else if (err.message) {
      return new _APIError(err.message, err.code || ERROR_MESSAGES.ERROR_CODES.NETWORK_ERROR, 0);
    } else {
      return new _APIError(ERROR_MESSAGES.API.UNKNOWN_ERROR, ERROR_MESSAGES.ERROR_CODES.UNKNOWN_ERROR, 0);
    }
  }
  /**
  ...
  static fromResponseData(responseData, status) {
    const errorMessage = _APIError.extractErrorMessage(responseData);
    const errorCode = _APIError.extractErrorCode(responseData, status);
    return new _APIError(errorMessage, errorCode, status);
  }
  /**
...
// node_modules/@contentstack/core/dist/esm/src/lib/request.js
...
// node_modules/@contentstack/core/dist/esm/src/lib/retryPolicy/delivery-sdk-handlers.js
var defaultConfig = {
  maxRequests: 5,
  retryLimit: 5,
  retryDelay: 300
};
var retryRequestHandler = (req) => {
  req.retryCount = req.retryCount || 1;
  return req;
};
var retryResponseHandler = (response) => response;
var retryResponseErrorHandler = (error, config, axiosInstance) => {
  try {
    ...
    if (!response) {
      ...
      if (rateLimitRemaining !== void 0 && parseInt(rateLimitRemaining) <= 0) {
        retryCount++;
...
var retry = (error, config, retryCount, retryDelay, axiosInstance) => {
  if (retryCount > config.retryLimit) {
    return Promise.reject(error);
  }
...
var calculateRateLimitDelay = (headers) => {
  ...
  if (rateLimitReset) {
    const resetTime = parseInt(rateLimitReset) * 1e3;
    const currentTime = Date.now();
    const delay = resetTime - currentTime;
    return Math.max(delay + 1e3, 1e3);
  }
...
// node_modules/@contentstack/delivery-sdk/dist/modern/persistance/helper/utils.js
var iGlobal = typeof window !== "undefined" ? window : global;

// node_modules/@contentstack/delivery-sdk/dist/modern/persistance/storages/local-storage.js
var localStorage = {
  name: "localStorage",
  clear,
  each,
...
// node_modules/@contentstack/delivery-sdk/dist/modern/persistance/storages/memory-storage.js
var memoryStorage = {
  name: "memoryStorage",
  clear: clear2,
  each: each2,
...
// node_modules/@contentstack/delivery-sdk/dist/modern/lib/error-messages.js
var ErrorMessages = {
  ...
  INVALID_REFERENCE_UID: (uid) => `Invalid referenceUid: ${uid}. Must be alphanumeric.`,
  ...
  SLACK_MESSAGE_FAILED: (details) => `Failed to send Slack message. Check the SLACK_WEBHOOK_URL and SLACK_CHANNEL configuration and try again.${details ? ` Details: ${details}` : ""}`,
  SLACK_FAILURE_DETAILS_FAILED: (details) => `Failed to send failure details to Slack. Verify SLACK_WEBHOOK_URL, SLACK_CHANNEL, and SLACK_TOKEN settings and try again.${details ? ` Details: ${details}` : ""}`
};
var ErrorCode = ((ErrorCode2) => {
  ErrorCode2["INVALID_FIELD_UID"] = "INVALID_FIELD_UID";
  ErrorCode2["INVALID_KEY"] = "INVALID_KEY";
  ErrorCode2["INVALID_REFERENCE_UID"] = "INVALID_REFERENCE_UID";
  ErrorCode2["INVALID_VALUE"] = "INVALID_VALUE";
  ErrorCode2["INVALID_ARGUMENT"] = "INVALID_ARGUMENT";
  ErrorCode2["MISSING_STORAGE"] = "MISSING_STORAGE";
  ErrorCode2["INVALID_REGEX"] = "INVALID_REGEX";
  ErrorCode2["SLACK_ERROR"] = "SLACK_ERROR";
  return ErrorCode2;
})(ErrorCode || {});

// node_modules/@contentstack/delivery-sdk/dist/modern/persistance/persistance-store.js
var PersistanceStore = class {
  ...
  constructor(config) {
    ...
    this.setStore(defaultConfig2.storeType, defaultConfig2.storage);
    this.config = defaultConfig2;
    this.name = "";
  }
  setStore(type, store) {
    switch (type) {
...
// node_modules/@contentstack/delivery-sdk/dist/modern/lib/types.js
var Region = ((Region2) => {
  Region2["US"] = "us";
  Region2["EU"] = "eu";
  Region2["AU"] = "au";
  Region2["AZURE_NA"] = "azure-na";
  Region2["AZURE_EU"] = "azure-eu";
  Region2["GCP_NA"] = "gcp-na";
  Region2["GCP_EU"] = "gcp-eu";
  return Region2;
})(Region || {});
var Policy = ((Policy2) => {
  Policy2["IGNORE_CACHE"] = "IGNORE_CACHE";
  Policy2["CACHE_THEN_NETWORK"] = "CACHE_THEN_NETWORK";
  Policy2["CACHE_ELSE_NETWORK"] = "CACHE_ELSE_NETWORK";
  Policy2["NETWORK_ELSE_CACHE"] = "NETWORK_ELSE_CACHE";
  return Policy2;
})(Policy || {});
var PublishType = ((PublishType2) => {
  PublishType2["ENTRY_PUBLISHED"] = "entry_published";
  PublishType2["ENTRY_UNPUBLISHED"] = "entry_unpublished";
  PublishType2["ENTRY_DELETED"] = "entry_deleted";
  PublishType2["ASSET_PUBLISHED"] = "asset_published";
  PublishType2["ASSET_UNPUBLISHED"] = "asset_unpublished";
  PublishType2["ASSET_DELETED"] = "asset_deleted";
  PublishType2["CONTENT_TYPE_DELETED"] = "content_type_deleted";
  return PublishType2;
})(PublishType || {});
var Format = ((Format2) => {
  Format2["GIF"] = "gif";
  ...
  Format2["PJPG"] = "pjpg";
  Format2["WEBP"] = "webp";
  Format2["WEBPLL"] = "webpll";
  Format2["WEBPLY"] = "webply";
  return Format2;
})(Format || {});
var CropBy = ((CropBy2) => {
  CropBy2["DEFAULT"] = "default";
  CropBy2["ASPECTRATIO"] = "aspectRatio";
  CropBy2["REGION"] = "region";
  CropBy2["OFFSET"] = "offset";
  return CropBy2;
})(CropBy || {});
var FitBy = ((FitBy2) => {
  FitBy2["BOUNDS"] = "bounds";
  FitBy2["CROP"] = "crop";
  return FitBy2;
})(FitBy || {});
var Orientation = ((Orientation2) => {
  Orientation2[Orientation2["DEFAULT"] = 1] = "DEFAULT";
  Orientation2[Orientation2["FLIP_HORIZONTAL"] = 2] = "FLIP_HORIZONTAL";
  Orientation2[Orientation2["FLIP_HORIZONTAL_VERTICAL"] = 3] = "FLIP_HORIZONTAL_VERTICAL";
  Orientation2[Orientation2["FLIP_VERTICAL"] = 4] = "FLIP_VERTICAL";
  Orientation2[Orientation2["FLIP_HORIZONTAL_LEFT"] = 5] = "FLIP_HORIZONTAL_LEFT";
  Orientation2[Orientation2["RIGHT"] = 6] = "RIGHT";
  Orientation2[Orientation2["FLIP_HORIZONTAL_RIGHT"] = 7] = "FLIP_HORIZONTAL_RIGHT";
  Orientation2[Orientation2["LEFT"] = 8] = "LEFT";
  return Orientation2;
})(Orientation || {});
var OverlayAlign = ((OverlayAlign2) => {
  OverlayAlign2["TOP"] = "top";
  OverlayAlign2["BOTTOM"] = "bottom";
  OverlayAlign2["LEFT"] = "left";
  OverlayAlign2["RIGHT"] = "right";
  OverlayAlign2["MIDDLE"] = "middle";
  OverlayAlign2["CENTER"] = "center";
  return OverlayAlign2;
})(OverlayAlign || {});
var OverlayRepeat = ((OverlayRepeat2) => {
  OverlayRepeat2["X"] = "x";
  OverlayRepeat2["Y"] = "y";
  OverlayRepeat2["BOTH"] = "both";
  return OverlayRepeat2;
})(OverlayRepeat || {});
var ResizeFilter = ((ResizeFilter2) => {
  ResizeFilter2["NEAREST"] = "nearest";
  ResizeFilter2["BILINEAR"] = "bilinear";
  ResizeFilter2["BICUBIC"] = "bicubic";
  ResizeFilter2["LANCZOS2"] = "lanczos2";
  ResizeFilter2["LANCZOS3"] = "lanczos3";
  return ResizeFilter2;
})(ResizeFilter || {});
var CanvasBy = ((CanvasBy2) => {
  CanvasBy2["DEFAULT"] = "default";
  CanvasBy2["ASPECTRATIO"] = "aspectRatio";
  CanvasBy2["REGION"] = "region";
  CanvasBy2["OFFSET"] = "offset";
  return CanvasBy2;
})(CanvasBy || {});
var QueryOperation = ((QueryOperation2) => {
  QueryOperation2["EQUALS"] = "";
  QueryOperation2["NOT_EQUALS"] = "$ne";
  QueryOperation2["INCLUDES"] = "$in";
  QueryOperation2["EXCLUDES"] = "$nin";
  QueryOperation2["IS_LESS_THAN"] = "$lt";
  QueryOperation2["IS_LESS_THAN_OR_EQUAL"] = "$lte";
  QueryOperation2["IS_GREATER_THAN"] = "$gt";
  QueryOperation2["IS_GREATER_THAN_OR_EQUAL"] = "$gte";
  QueryOperation2["EXISTS"] = "$exists";
  QueryOperation2["MATCHES"] = "$regex";
  return QueryOperation2;
})(QueryOperation || {});
var TaxonomyQueryOperation = ((TaxonomyQueryOperation2) => {
  TaxonomyQueryOperation2["ABOVE"] = "$above";
  TaxonomyQueryOperation2["BELOW"] = "$below";
  TaxonomyQueryOperation2["EQ_ABOVE"] = "$eq_above";
  TaxonomyQueryOperation2["EQ_BELOW"] = "$eq_below";
  return TaxonomyQueryOperation2;
})(TaxonomyQueryOperation || {});
var QueryOperator = ((QueryOperator2) => {
  QueryOperator2["AND"] = "$and";
  QueryOperator2["OR"] = "$or";
  return QueryOperator2;
})(QueryOperator || {});

// node_modules/@contentstack/delivery-sdk/dist/modern/lib/cache.js
...
// node_modules/@contentstack/delivery-sdk/dist/modern/lib/asset.js
var Asset = class {
   ...
   */
  version(version2) {
    this._queryParams.version = String(version2);
    return this;
  }
  /**
   * @method locale
...
// node_modules/@contentstack/delivery-sdk/dist/modern/lib/pagination.js
var Pagination = class {
  ...
  paginate(paginationObj) {
    this._queryParams.skip = (paginationObj == null ? void 0 : paginationObj.skip) || 0;
    this._queryParams.limit = (paginationObj == null ? void 0 : paginationObj.limit) || 10;
    return this;
  }
  /**
   * @method next
...
// node_modules/@contentstack/delivery-sdk/dist/modern/lib/utils.js
var import_utils24 = __toESM(require_index_es(), 1);
function getHostforRegion(region, host) {
  if (host) return host;
  return (0, import_utils24.getContentstackEndpoint)(region, "contentDelivery", true);
}
function isBrowser() {
...
function encodeQueryParams(params) {
  ...
  for (const [key, value] of Object.entries(params)) {
    if (typeof value === "string") {
      ...
      encodedParams[key] = encodeQueryParams(value);
    } else {
...
// node_modules/@contentstack/delivery-sdk/dist/modern/lib/base-query.js
var BaseQuery = class extends Pagination {
  constructor() {
    super(...arguments);
    this._parameters = {};
  }
...
// node_modules/@contentstack/delivery-sdk/dist/modern/lib/query.js
var Query = class extends BaseQuery {
  constructor(client, params2, queryParams2, variants, uid, queryObj) {
    ...
    this._parameters = params2 || {};
    this._queryParams = queryParams2 || {};
  ...
  async find(encode3 = false) {
    ...
    if (Object.keys(this._parameters).length > 0) {
      ...
      if (encode3) {
        queryParams2 = encodeQueryParams(queryParams2);
      }
...
// node_modules/@contentstack/delivery-sdk/dist/modern/lib/asset-query.js
var AssetQuery = class extends BaseQuery {
  constructor(client) {
    super();
    this._client = client;
    this._urlPath = "/assets";
...
// node_modules/@contentstack/delivery-sdk/dist/modern/lib/entry.js
var Entry = class {
  ...
  includeReference(...referenceFieldUid) {
    if (referenceFieldUid.length) {
      referenceFieldUid.forEach((value) => {
        ...
        this._queryParams["include[]"].push(...Array.isArray(value) ? value : [value]);
      });
    } else {
...
// node_modules/@contentstack/delivery-sdk/dist/modern/lib/entries.js
var Entries = class extends BaseQuery {
...
// node_modules/@contentstack/delivery-sdk/dist/modern/lib/content-type.js
...
// node_modules/@contentstack/delivery-sdk/dist/modern/lib/contenttype-query.js
var ContentTypeQuery = class {
  constructor(client) {
    this._queryParams = {};
    this._client = client;
...
// node_modules/@contentstack/delivery-sdk/dist/modern/lib/synchronization.js
var import_humps = __toESM(require_humps(), 1);
async function synchronization(client, params = {}, recursive = false) {
  ...
  let response = await getData(client, SYNC_URL, { params: import_humps.default.decamelizeKeys(config.params) });
  const data = response.data;
  while (recursive && "pagination_token" in response.data) {
    const recResponse = await getData(
      client,
      SYNC_URL,
      import_humps.default.decamelizeKeys({ paginationToken: data.pagination_token })
    );
...
// node_modules/@contentstack/delivery-sdk/dist/modern/lib/taxonomy-query.js
var TaxonomyQuery = class extends Query {
  constructor(client) {
    super(client, {}, {});
    this._client = client;
...
// node_modules/@contentstack/delivery-sdk/dist/modern/lib/global-field-query.js
var GlobalFieldQuery = class extends BaseQuery {
  constructor(client) {
    super();
    this._client = client;
...
// node_modules/@contentstack/delivery-sdk/dist/modern/lib/global-field.js
var GlobalField = class {
...
// node_modules/@contentstack/delivery-sdk/dist/modern/lib/stack.js
var Stack = class {
...
// node_modules/@contentstack/delivery-sdk/dist/modern/lib/contentstack.js
var Utils = __toESM(require_index_es(), 1);
var version = "{{VERSION}}";
function stack(config) {
  const DEFAULT_HOST = getHostforRegion(config.region || Region.US, config.host);
  let defaultConfig2 = {
  ...
  config.host = defaultConfig2.defaultHostname;
  if (config.apiKey) {
    defaultConfig2.headers.api_key = config.apiKey;
  } else {
    throw new Error("API key for Stack is required.");
  }
  if (config.deliveryToken) {
    defaultConfig2.headers.access_token = config.deliveryToken;
  } else {
    throw new Error("Delivery token for Stack is required.");
  }
  if (config.environment) {
    defaultConfig2.params.environment = config.environment;
  } else {
    throw new Error("Environment for Stack is required");
  }
  if (config.locale) {
    defaultConfig2.params.locale = config.locale;
  }
  if (config.live_preview) {
    if (isBrowser()) {
      ...
      if (params.has("release_id")) {
        defaultConfig2.headers["release_id"] = params.get("release_id");
      }
      if (params.has("preview_timestamp")) {
        defaultConfig2.headers["preview_timestamp"] = params.get("preview_timestamp");
      }
    }
  }
  if (config.branch) {
    defaultConfig2.headers.branch = config.branch;
  }
  if (config.early_access) {
    defaultConfig2.headers["x-header-ea"] = config.early_access.join(",");
  }
  defaultConfig2.headers["X-User-Agent"] = "contentstack-delivery-typescript/" + version;
  const client = httpClient(defaultConfig2);
  ...
  if (config.debug) {
    client.interceptors.request.use((requestConfig) => {
      ...
      config.logHandler("info", {
        type: "request",
        method: (_a = requestConfig.method) == null ? void 0 : _a.toUpperCase(),
    ...
    client.interceptors.response.use(
      ...
      (error) => {
        ...
        config.logHandler(level, {
          type: "response_error",
          status,
          statusText: ((_b = error.response) == null ? void 0 : _b.statusText) || error.message,
          url: (_c = error.config) == null ? void 0 : _c.url,
          method: (_e = (_d = error.config) == null ? void 0 : _d.method) == null ? void 0 : _e.toUpperCase(),
          error: error.message,
          timestamp: (/* @__PURE__ */ new Date()).toISOString()
        });
        throw error;
  ...
  return new Stack(client, config);
}

// node_modules/@contentstack/delivery-sdk/dist/modern/index.js
var index_default = contentstack_exports;
export {
  CanvasBy,
  CropBy,
  ErrorCode,
...
lodash/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=@contentstack_delivery-sdk.js.map
