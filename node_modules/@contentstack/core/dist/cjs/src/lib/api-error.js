...
class APIError extends Error {
    ...
    static fromAxiosError(err) {
        ...
        if ((_a = err.response) === null || _a === void 0 ? void 0 : _a.data) {
            ...
            return new APIError(err.message, err.code || error_messages_1.ERROR_MESSAGES.ERROR_CODES.NETWORK_ERROR, 0);
        }
        else {
            // Fallback for unknown errors
            return new APIError(error_messages_1.ERROR_MESSAGES.API.UNKNOWN_ERROR, error_messages_1.ERROR_MESSAGES.ERROR_CODES.UNKNOWN_ERROR, 0);
        }
    }
    /**
    ...
    static extractErrorMessage(responseData) {
        ...
        if (typeof responseData === 'string')
            return responseData;
        return error_messages_1.ERROR_MESSAGES.API.REQUEST_FAILED();
    }
    /**
